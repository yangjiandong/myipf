...
}if(d&&(typeof d=="string")&&(d!="All topics")){a.setModeLabel(d)
}else{a.setModeLabel("All topics")
}});
...
$("#notLikeMore").show();
$("#showMeMore").hide()
}}}}if(typeof this.currentStumble.publicid=="undefined"||this.currentStumble.publicid==""){$("#like, #showMeMore, #notLike, #notLikeMore, #share, #facebook, #twitter, #email, #reviews, #friends, #sponsored").hide()
...
}else{if(this.currentStumble.method_used=="general"){this.setModeLabel("All topics");
suExtensionApi.message.broadcastMessage("localUpdateModeLabel","All topics")
