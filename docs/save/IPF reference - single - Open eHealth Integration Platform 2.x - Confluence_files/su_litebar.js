...
if(a=="All topics"){$("#topics").removeClass("cancel").addClass("default")
...
a.data.instance.setModeLabel("All topics");
if(a.data.instance.device=="chromebar"){suExtensionApi.message.broadcastMessage("localUpdateStumblingTopic",{id:0,name:"All topics"})
